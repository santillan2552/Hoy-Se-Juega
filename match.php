...
.copy-btn { width: 100%; padding: 10px; border-radius: 8px; background: #222; border: 1px solid #444; color: #eee; font-size: 14px; cursor: pointer; margin-top: 8px; display: none; }
...
<button class="save-btn" onclick="generate()">Generar match.json</button>
<div class="status" id="status"></div>
<div class="output" id="output"></div>
<button class="copy-btn" id="copy-btn" onclick="copyJson()">Copiar JSON</button>
...
function generate() {
  ...
  document.getElementById('status').textContent = 'Copiá el JSON y pegalo en match.json de GitHub, luego usá el comando del servidor.';
